        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div className="input-group mb-3">
                    <input type="text" className="form-control" defaultValue='5' disabled={true} ref={editUnit => (inputUnit = editUnit)} />
                ...
                <div className="input-group mb-3">
                    <input type="text" className="form-control" defaultValue='10' disabled={true} ref={editPrice => (inputPrice = editPrice)} />
